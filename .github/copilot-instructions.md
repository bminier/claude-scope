...
### Git / CI
- Default branch: `dev`. PRs target `dev`. Follow Conventional Commits — version bumps and `CHANGELOG.md` are generated by release-please from commit subjects (see `CONTRIBUTING.md`).
